...
INSERT INTO products(price, name, description, category) VALUES (1800, 'Pack of Beer', 'If you are too lazy to have a six pack, on yourself, buy one of these and drink away your sadness.', 'ALCOHOL');
INSERT INTO products(price, name, description, category) VALUES (10000, 'Hot Wheels Car', 'Buy this if you do not want to spend time with your kid.', 'KID');